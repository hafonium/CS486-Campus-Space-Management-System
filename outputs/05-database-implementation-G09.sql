...
-- ============================================================================
-- 0. TEARDOWN (Idempotency - safely drops existing objects before creating)
-- ============================================================================

-- Drop Foreign Keys & Triggers first
IF OBJECT_ID('dbo.trg_booking_validation', 'TR') IS NOT NULL DROP TRIGGER dbo.trg_booking_validation;
