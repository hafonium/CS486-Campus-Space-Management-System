---
name: logical-design
description: Translate a Conceptual Entity-Relationship Diagram (ERD) into a Relational Schema using DBML syntax. Map entities to tables, resolve M:N relationships, establish Primary/Foreign Keys, define Enums, and apply constraints.
---
...
The final output must provide a strict relational schema written in DBML (Database Markup Language) ready for SQL implementation, ensuring all business rules, referential integrity, and cardinality constraints are mathematically resolvable.
